...
declare module "#imports" {
  ...
  export {
    default as serverLoginStories,
    NotLoggedIn,
    LoggedIn,
    ServerLoadingState,
  } from "../src/components/ServerLogin.stories";
  export { default as ServerLogin } from "../src/components/ServerLogin";
  export {
    default as zaimLoginStories,
    NotConnected,
    Connected,
    ZaimLoadingState,
  } from "../src/components/ZaimLogin.stories";
  export { default as ZaimLogin } from "../src/components/ZaimLogin";
}
