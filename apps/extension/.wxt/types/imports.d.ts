...
export {};
declare global {
  const Connected: typeof import("/home/user/quick-zaim-ext/apps/extension/src/components/ZaimLogin.stories").Connected;
  const ContentScriptContext: typeof import("wxt/utils/content-script-context").ContentScriptContext;
  const InvalidMatchPattern: typeof import("wxt/utils/match-patterns").InvalidMatchPattern;
  const LoggedIn: typeof import("/home/user/quick-zaim-ext/apps/extension/src/components/ServerLogin.stories").LoggedIn;
  const MatchPattern: typeof import("wxt/utils/match-patterns").MatchPattern;
  const NotConnected: typeof import("/home/user/quick-zaim-ext/apps/extension/src/components/ZaimLogin.stories").NotConnected;
  const NotLoggedIn: typeof import("/home/user/quick-zaim-ext/apps/extension/src/components/ServerLogin.stories").NotLoggedIn;
  const ServerLoadingState: typeof import("/home/user/quick-zaim-ext/apps/extension/src/components/ServerLogin.stories").ServerLoadingState;
  const ServerLogin: typeof import("/home/user/quick-zaim-ext/apps/extension/src/components/ServerLogin").default;
  const ZaimLoadingState: typeof import("/home/user/quick-zaim-ext/apps/extension/src/components/ZaimLogin.stories").ZaimLoadingState;
  const ZaimLogin: typeof import("/home/user/quick-zaim-ext/apps/extension/src/components/ZaimLogin").default;
  ...
  const serverLoginStories: typeof import("/home/user/quick-zaim-ext/apps/extension/src/components/ServerLogin.stories").default;
  ...
  const zaimLoginStories: typeof import("/home/user/quick-zaim-ext/apps/extension/src/components/ZaimLogin.stories").default;
}
// for type re-export
declare global {
  // @ts-ignore
